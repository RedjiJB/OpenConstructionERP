  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-surface-primary p-8">
      <div className="max-w-md text-center">
        <div className="mb-6 text-9xl font-extrabold bg-gradient-to-r from-oe-blue to-oe-purple bg-clip-text text-transparent select-none animate-fade-in">404</div>
